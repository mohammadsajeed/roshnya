                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" class="form-control" id="fname"  name="title"  name="title" placeholder=" Plaese type News Title Here ">
                                @error('title')
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" class="form-control"  name="date" placeholder=" Plaese type news Data" >
                                @error('picture')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <textarea type="text" class="form-control" cols="3" id="editor1" name="description" placeholder=" Plaese type News Description  Here">
                                </textarea>
                                @error('description')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
